...
export const projects: Project[] = [
   {
      ...
      stage: "On-water testing of our breakout-board prototypes has been very successful, winning approval of coaches, coxswains, and rowers. We are currently designing custom hardware to miniaturize, reduce clutter, and increase range.",
   ...
   },
   {
      ...
      stage: "With radio links established through breakout hardware, we are now programming the major features.",
      image1: "/products/ergminder_prototype2.jpg",
      lastUpdated: "Jan 2026"
   },
   {
      name: "SaltLight",
      description: "Anticipated to be our first product for sale, this boat light is designed to reduce expenses for teams rowing on brackish water. A modern, modular design, the main board will not be exposed to elements even while charging.",
